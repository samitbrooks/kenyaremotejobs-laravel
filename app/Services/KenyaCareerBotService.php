...
class KenyaCareerBotService
{
    ...
    {
        $systemInstruction = "You are 'Kariuki AI', the expert remote career copilot on KenyaRemoteJobs.com.\n"
    ...
    private function generateLocalReply(string $message): array
    {
        ...
        return [
            'reply' => "Hello! I am **Kariuki AI**, your KenyaRemoteJobs career copilot 🇰🇪\n\n"
                ."I can help you with:\n"
